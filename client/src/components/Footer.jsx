        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">Newsroom</a>
                </li>
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">Tailwind CSS</a>
                </li>
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">Careers</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">Github</a>
                </li>
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">LinkedIn</a>
                </li>
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">Twitter</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">About</a>
                </li>
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">Privacy Policy</a>
                </li>
                <li>
                  <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">Terms &amp; Conditions</a>
                </li>
              </ul>
            </div>
            ...
            <div className="flex items-center lg:justify-center max-sm:-order-1">
              <a href="#" onClick={(e) => e.preventDefault()}>
                <img src="https://readymadeui.com/readymadeui-light.svg" alt="logo" className="sm:w-56 w-40" />
              </a>
            </div>
          </div>
          ...
          <div className="flex sm:justify-between flex-wrap gap-6">
            <div className="flex space-x-5">
              <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-white text-sm transition-all">
